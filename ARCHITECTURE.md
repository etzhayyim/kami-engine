...
| Car sim | `kami-app-car-sim::run_car_sim` → `driver.etzhayyim.com/` | **shipped 2026-05** (3rd reference game; BeamNG-grade soft-body sedan demo backed by `kami-vehicle` physics crate; 3 custom wgpu pipelines — line wireframe / filled body Lambert / ground tiles with procedural WGSL textures; 8 surface zones on a single map) |
