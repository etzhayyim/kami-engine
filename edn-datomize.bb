...
;;                                                        裸キーだけ ns を付与)
;;
;; このコピーは kotoba-lang/kami-engine 用に schema-path のみ調整（manifest/ が無いので
;; リポジトリルート直下 schema.edn）。他のロジックは com-junkawasaki/root の
;; manifest/edn-datomize.bb と同一（wrap-map-keep-ns は kotoba-lang/security pilot 由来）。
...
;;            idiomatically namespaced, e.g. :authority/id, :render/pipelines) ----------
